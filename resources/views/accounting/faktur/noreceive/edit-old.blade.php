        ...
        <div class="col-lg-10">
            <div class="panel">
                <div class="panel-heading">
                    ...
                    <a href="{{ route('accounting.fakturnoreceive.index') }}" type="button" class="btn btn-md btn-primary pull-right">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="receive_updated_by" value="{{ auth()->user()->name }}" readonly></td>
                                </tr>
                            </table>
                        </div>
